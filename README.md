...
- [**License-plate-recognition**](https://github.com/kritaAu/License-plate-recognition)
  An end-to-end system using Flutter (TFLite) for detection, Python (YOLOv11) for frame scoring, and React/Spring Boot for the dashboard.
  
- [**Flutter-DetectMotorcycle**](https://github.com/kritaAu/Flutter-DetectMotorcycle)
  A real-time motorcycle detection mobile application developed with Flutter and TensorFlow Lite. Features automated on-device image batching and seamless API integration to sync detected data with the backend for further processing.

  
- [**Lost & Found Management System**](https://github.com/Phxtanes/Unifind-jing)
  A scalable backend platform using Spring Boot and MongoDB with secure RESTful APIs for efficient item tracking.
